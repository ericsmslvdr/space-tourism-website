...
const HomeSection = () => {
    return (
        <section className="grow px-4 pt-4 md:pt-16">
            <div className="h-full flex flex-col md:w-3/4 mx-auto lg:pb-20 lg:flex-row lg:items-end lg:justify-end">
                    ...
                    <Link to={'/destination'}>
                        <div className='relative cursor-pointer'>
                            <div className='group w-[144px] h-[144px] rounded-full grid place-content-center bg-white md:w-[272px] md:h-[272px] hover:outline-[72px]'>
                                ...
                                <div className='w-[0px] h-[0px] rounded-full bg-white/20 absolute top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%] group-hover:size-[244px] md:group-hover:size-[375px] transition-all duration-300 ease'></div>
                            </div>
                        </div>
                    </Link>
                </div>
